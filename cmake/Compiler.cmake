...
function(fe_add_export_definition_ TARGET_NAME)
    ...
    if(FALCON_ENGINE_BUILD_DYNAMIC_LIBRARY)
        ...
        add_definitions(-DFALCON_ENGINE_BUILD_${TARGET_NAME}_STATIC)
    endif()
endfunction()

function(fe_add_export_definition TARGET_NAME_LIST)
    foreach(TARGET_NAME ${TARGET_NAME_LIST})
        fe_add_export_definition_(${TARGET_NAME})
    endforeach()
endfunction()
...
function(fe_add_import_definition_ TARGET_NAME)
    ...
    assert_defined(FALCON_ENGINE_BUILD_DYNAMIC_LIBRARY)
    if(FALCON_ENGINE_BUILD_DYNAMIC_LIBRARY)
        add_definitions(-DFALCON_ENGINE_SYMBOL_${TARGET_NAME}_IMPORT)
    else()
        add_definitions(-DFALCON_ENGINE_BUILD_${TARGET_NAME}_STATIC)
    endif()
endfunction()
