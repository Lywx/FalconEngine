...
// TODO
//extern const GLint  OpenGLAttributeChannels[VertexFormat::AT_QUANTITY];
//extern const GLuint OpenGLAttributeType[VertexFormat::AT_QUANTITY];
...
//extern GLenum OpenGLPrimitiveType[Visual::PT_MAX_QUANTITY];
