#include <FalconEngine/Graphics/Renderers/OpenGL/OpenGLVertexFormat.h>
#include <FalconEngine/Graphics/Renderers/OpenGL/OpenGLExtensions.h>
...
/************************************************************************/
OpenGLVertexFormat::OpenGLVertexFormat(Renderer *,
...
void OpenGLVertexFormat::Enable(Renderer *)
{
...
void OpenGLVertexFormat::Disable(Renderer *)
{
    if (m_hasPosition)
    {
