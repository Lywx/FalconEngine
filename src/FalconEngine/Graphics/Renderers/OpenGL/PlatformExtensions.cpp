...
const GLenum OpenGLBlendFactorSource[int(BlendFactorSource::ENUM_COUNT)] =
{
    GL_ZERO,
    GL_ONE,
    GL_SRC_COLOR,
...
const GLenum OpenGLBlendFactorDestination[int(BlendFactorDestination::ENUM_COUNT)] =
{
    GL_ZERO,
    GL_ONE,
    GL_SRC_COLOR,
...
const GLenum OpenGLDepthCompareFunction[int(DepthCompareFunction::ENUM_COUNT)] =
{
...
const GLenum OpenGLStencilFunction[int(StencilFunction::ENUM_COUNT)] =
{
    GL_NEVER,
    GL_ALWAYS,
    GL_LESS,
...
const GLenum OpenGLStencilOperation[int(StencilOperation::ENUM_COUNT)] =
{
    GL_KEEP,
    GL_ZERO,
    GL_REPLACE,
...
const GLuint OpenGLBufferAccessMode[int(BufferAccessMode::ENUM_COUNT)] =
{
    GL_READ_ONLY,
    GL_WRITE_ONLY,
    GL_READ_WRITE,
...
const GLuint OpenGLBufferUsage[int(BufferUsage::ENUM_COUNT)] =
{
    GL_INVALID_ENUM,
...
//};
//
//GLuint OpenGLTextureTarget[Shader::ST_QUANTITY] =
//{
//    0,                  // ST_NONE
//    GL_TEXTURE_1D,      // ST_1D
//    GL_TEXTURE_2D,      // ST_2D
