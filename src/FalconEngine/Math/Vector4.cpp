...
/************************************************************************/
const Vector4f
Vector4f::Zero = Vector4f(0.f, 0.f, 0.f, 0.f);

const Vector4f
Vector4f::UnitX = Vector4f(1.f, 0.f, 0.f, 0.f);

const Vector4f
Vector4f::UnitY = Vector4f(0.f, 1.f, 0.f, 0.f);

const Vector4f
Vector4f::UnitZ = Vector4f(0.f, 0.f, 1.f, 0.f);

const Vector4f
Vector4f::UnitW = Vector4f(0.f, 0.f, 0.f, 1.f);
